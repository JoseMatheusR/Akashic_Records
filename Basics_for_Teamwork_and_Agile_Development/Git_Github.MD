...
|Tipo|Descrição|
|-|-|
|**Soft**|O commit é desfeito, mas as mudanças continuam no estado `staged`|
|**Mixed**|Semelhante ao soft, mas deixa as mudanças como unstaged. Sendo ecessário adicioná-las novamente.|
